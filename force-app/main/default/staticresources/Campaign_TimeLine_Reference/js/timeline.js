...
links.Timeline.prototype.onMouseDown = function(event) {
	...
	//added by santhosh to remove the info panel
	var chk = document.getElementById("tooltipDiv");
	if(chk != null){		
...
links.Timeline.ItemRange.prototype.updateDOM = function () {
    ...
    if (divBox) {
        ...
        // update contents
        //divBox.firstChild.innerHTML = this.content; // commented by Santhosh
		var textTitle = document.createTextNode(this.content); // added by Santhosh
		var img = document.createElement("img");
			//var rect = img.getBoundingClientRect();
            img.src = "{!URLFOR($Resource.Campaign_TimeLine_Reference,'images/campaign_img.GIF')}";
			//img.onmouseover = function() {ddrivetip(val,this)};//showtip(this,event)};
			//img.onmouseout = function() {hideddrivetip()};
			img.onclick = function() {createTooltip(val,divBox)};
			//img.setAttribute("id","tooltipDisp")
		...
		var a = document.createElement("a");
			...
			a.onclick = function() {createTooltip(val,divBox)};
		divBox.appendChild(a); // added by Santhosh
		
		var tooltip = document.createElement("DIV");
		tooltip.setAttribute("id", "tooltip");
		tooltip.className = "ttip";
