...
//custom import
import init from "@salesforce/apex/lghtCreateCaseWithAttrCTRL.InitGestori";
import searchAgent from "@salesforce/apex/lghtCreateCaseWithAttrCTRL.searchGestore";
import associateCase from "@salesforce/apex/lghtCreateCaseWithAttrCTRL.associateCase";


export default class SCVManagementGestori extends NavigationMixin(LightningElement) {
    ...
    async handleAssociate(event){
        ...
        if(event.target.dataset){
            ...
            var result = await associateCase({VCId : this.recordId, CaseId : CaseId, Type: 'Gestori'});
            this.showSpinner = false;            
        }
    ...
    handleCreate(event){
        if(event.target.dataset){
            if(event.target.dataset.userid){
                this.CaseDefaultValues.AgentName__c = event.target.dataset.userid;
            }
