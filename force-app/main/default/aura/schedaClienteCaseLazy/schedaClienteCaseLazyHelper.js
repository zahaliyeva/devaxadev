({
    ...
    onSetColumnsAndQuickactions: function(component){
        component.set('v.columns',[
            {label:'Numero Case', fieldName:'caseId', type:'url', shortable: true, hideDefaultActions: true, typeAttributes: {
                    label: { fieldName: 'caseNumber' }
                }
            },
            {label: 'Categoria', fieldName:'category', type:'text', shortable: true, hideDefaultActions: true},
            {label: 'Sotto-Categoria', fieldName:'subCategory', type:'text', shortable: true, hideDefaultActions: true},
            {label: 'Oggetto Apertura Case', fieldName:'subject', type:'text', shortable: true, hideDefaultActions: true},
            {label: 'Stato', fieldName:'status', type:'text', shortable: true, hideDefaultActions: true},
