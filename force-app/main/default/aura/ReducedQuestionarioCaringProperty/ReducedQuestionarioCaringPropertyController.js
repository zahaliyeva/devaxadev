({
    doInit : function(component, event, helper) 
    {
        ...
        component.set('v.questionarioCA.Data_Evento__c', today);
        component.set('v.Today', today);
        component.set('v.Now', new Date());
        console.log("Data: " + component.get('v.questionarioCA.Data_Evento__c'));
    ...
    calculateFiscalCodeContr : function (component , event, helper){
        var surname = component.get("v.questionarioCA.Cognome_Contraente__c") ;
        var name = component.get("v.questionarioCA.Nome_contraente__c"); 
        var city = component.get("v.comuneNascitaContr"); 
        var province = component.get("v.provinciaNascitaContr");
        var birthDate = ''+component.get("v.questionarioCA.Data_di_nascita_contraente__c"); 
        var gender = component.get("v.questionarioCA.Sesso_Contraente__c"); 
             ...
             action.setParams({"surname" : surname,
                           ...
                           action.setCallback(this,function(response){
                             ...
                             if (state === "SUCCESS") {
                                     ...
                                     component.set("v.questionarioCA.Codice_fiscale_contraente__c",result);
