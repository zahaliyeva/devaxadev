({
    ...
    MobilePhoneChange : function(component, event, helper) {
        ...
        component.set("v.Recapiti_B2C.CIF_PersonMobilePhone__c", new_MobilePhone);
    ...
    WorkEmailChange: function (component, event, helper){
        ...
        component.set("v.Recapiti_B2C.CIF_Work_email__c", new_WorkEmail);
