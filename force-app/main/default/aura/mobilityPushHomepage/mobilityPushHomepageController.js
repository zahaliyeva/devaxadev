({
    ...
    closeComponent: function(cmp,evt,help){
        var hook = {"id":"mobilityPushHomepage", "action":"NAVIGATETO","target":{"name":"homepage","label":"Homepage","action":"homepageCallback","parent":null,"active":false,"params":{}}};
        window.parent.postMessage(hook,'*');
    },
