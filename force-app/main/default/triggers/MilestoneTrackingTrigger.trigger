trigger MilestoneTrackingTrigger on Milestone_Tracking__c (before insert,before update,after insert,after update) {
   ...
   {
    TriggerFactory.createHandler('MilestoneTrackingHandler');
   }
