trigger CustomerDocumentDownloadEventTrigger on Customer_Document_Download__e (after insert) {
	...
	{
	   TriggerFactory.createHandler('CustomerDocumentDownloadEventHandler');
	}
}