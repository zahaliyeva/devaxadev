trigger CustomerCommunicationBounceEventTrigger on Customer_Communication_Bounce__e (after insert) {
	...
	if (DEACTIVATE_TRIGGER == FALSE){
		TriggerFactory.createHandler('CommunicationBounceEventHandler');
	}
}