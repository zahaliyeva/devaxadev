trigger IndividualEmailResultTrigger on et4ae5__IndividualEmailResult__c (before insert, before update, after insert, after update, before delete, after delete, after undelete) {
	...
	{
	   TriggerFactory.createHandler('IndividualEmailResultHandler');
	}
}